...
#directory
            fname='node{0}_july2/timestamp_voltage.all.1919_2_july2.{1}.dat'.format(n,i)
...
n=33
while n < 49:
    name='node{0}/a_d/coordinated_generated_sequence.dat'.format(n)
    master=[]
    node=n-33
    for i in range(len(masterlist)):
...
name='a-d_MasterSequenceFile.dat'
master=[]
for i in range(len(masterlist)):
