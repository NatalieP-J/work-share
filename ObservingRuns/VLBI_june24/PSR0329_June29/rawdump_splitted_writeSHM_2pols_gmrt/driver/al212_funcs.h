...
//------------------------------------------------------------------------------  
// RCS:
// $Id: al212_funcs.h,v 1.2 2004/12/22 19:29:06 mwyrick Exp $
// $Log: al212_funcs.h,v $
...
//
//-----------------------------------------------------------------------------
static void initAL212(int);
static int Upload212RBF(int, char *data, long size);
static void AL212_BrdAbortDMA(int);
