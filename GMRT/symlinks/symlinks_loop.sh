...
#FILE=3c286_Aug16_1.node #should be whatever is used to identify files during an 'ls' search
#NAME=3c286_Aug16_1 #full part of the file name preceding the .node
#SCAN=_1.node #format _[scan number].node is required
STEM=/mnt/*/gsbuser/TSAS/node* #location of files used to identify them during an 'ls' search
DISKOUT=$4 #disk the files should be linked to
