...
if __name__ == '__main__':
    ...
    # psr = 'noise'
     ...
     phasepol_dict = {'B0329+54': Polynomial([0., 1.399541538720]),
                     'B1919+21': Polynomial([0.5,0.7477741603725,-7.53872E-16]),
     ...
     fndir1 = '/mnt/c/algonquin/July25/PSR1919/node9/'
    # file1 = fndir1 + 'stream0329.1.dat'
    # file1 = fndir1 + 'stream.0329_VLBI_june30.1.dat'
    # file1 = fndir1 + 'stream.2013-07-25T15:33:45.0.dat'
     file1 = fndir1 + 'stream.2013-07-25T18:14:20.0.dat'
     nhead = 0
    # had 4639 * 32MB =
     size = 31641829376 #size of stream file
    # frequency channels to make
     nchan = 1024 
     ntbin = 16 # number of bins the time series is split into for folding
