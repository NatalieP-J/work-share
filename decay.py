...
import numpy as np
import pylab as py 
#I have simplified the original function. Henceforth, n is the same as N-nought, and k is the same as tau. N(t)=n(e^((-t*ln2)/k))=n(e^ln2)^(-t/k)=n(2^-t/k), where n and k are starting conditions specified in the command line.
print """
Radioactive decay.
...
N=n*(2**(-t/k))#Rewrite the function to avoid referencing the one in the while loop.
