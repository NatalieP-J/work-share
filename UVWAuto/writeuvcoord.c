...
//#define PNT_RA 5.0600003897402273 //PSR B1919+21 May 16 2013
//#define PNT_DEC 0.3490658503988659

#define NPOD 30 /*Number of baselines over which to iterate*/
#define EPOCH_START (0)
#define NEPOCH (4797) /*Number of lines in my timestamp file plus 1 - specifies the number of times we want antenna coordinates 4797 for 1957, 1197 for 1919*/
