...
#define PNT_RA 5.0690771926813802 //PSR B1919+21 May 16 2013
#define PNT_DEC 0.38194712628591737

#define NPOD 30 /*Number of baselines over which to iterate*/
#define EPOCH_START (0)
#define NEPOCH (1197) /*Number of lines in my timestamp file plus 1 - specifies the number of times we want antenna coordinates 4797 for 1957, 1197 for 1919*/
